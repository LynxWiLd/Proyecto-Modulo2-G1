      ...
      <section className="text-ligth position-relative">
        ...
        <div className="imagen-container">
          <Image
            ...
            fluid
            alt="imagen portada canción o album"
          />
        </div>
        ...
        <div className="overlay bottom-left text-white p-2">
          <p className="mb-0">
            <span className="fw-bold">ColdPlay - Parachutes</span> - 2000 - 4:26
            - 3.421.608.407
          </p>
        </div>
      </section>
