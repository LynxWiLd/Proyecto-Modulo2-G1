...
const Footer = () => (
  <footer className="text-white py-3 mt-auto" style={{ backgroundColor: "#000" }}>
    <Container className="text-center">
      <Row className="text-center text-white">
        ...
        <Col md={4}>
          ...
          <Link to="/about" className="text-white d-block">Sobre Nosotros</Link>
        </Col>

        <Col md={4}>
          <h6>Seguinos</h6>

          <Link to="/404" className="text-white mx-2">
            <FaInstagram size={24} />
          </Link>
